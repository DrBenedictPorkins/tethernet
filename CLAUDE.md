...
| Repo | Path | Role |
|------|------|------|
| `tethernet` (this) | `<EXTENSION_DIR>` | Chrome Manifest V3 extension |
| `tethernet-mcp` | `<MCP_DIR>` | MCP server (shared by both extensions) |
| `foxhole-debug-bridge` | `<FIREFOX_DIR>` | Firefox Manifest V2 extension |
